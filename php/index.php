      ...
      <!-- This checks that we dont have the data saved on the pc -->
        <?php
            if(!isset($_COOKIE[$FName])) {
               ...
               // echo "Cookie '" . $FName . "' is set!";
                echo "Value is: " . $_COOKIE[$FName];
            }
            if(!isset($_COOKIE[$SName])) {
                //echo "Cookie named '" . $SName . "' is not set!";
            } else {
                //echo "Cookie '" . $SName . "' is set!<br>";
                echo "Value is: " . $_COOKIE[$SName];
            }
            if(!isset($_COOKIE[$NHI])) {
                //echo "Cookie named '" . $NHI . "' is not set!";
            } else {
                //echo "Cookie '" . $NHI . "' is set!<br>";
